...
public class Admin {
    ...
    public Admin(int id, String name, String email, String password, String address, Boolean gender, 
            String phone, Roles roles, String created_by, String created_on, String modifile_by, String modifile_on) {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    public Admin(int id, String name, String email, String password, String address, Boolean gender, String phone, 
            Roles roles, String created_by, String created_on, String modifile_by, String modifile_on, String img) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.password = password;
