...
//            if (a == null && b != null) {
            ...
            ArrayList<User> userList = udao.getAllUser1();
            
            response.getWriter().println(userList.size());
            response.getWriter().println(adminList.size());
            ...
            for (Admin admin : adminList) {
                if (admin.getEmail().equals(email) && admin.getPassword().equals(md5.getMd5(pass))) {
