                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" action="Profile" enctype="multipart/form-data">
                                <div class="col-md-6">
                                        <img src="img/${sessionScope['account'].getImg()}" name="photo"  width="200" height="150" style="margin-left: 8%;">        
                                </div>
                                <div class="col-md-6">
                                    <label class="" >Link Img</label><input class="form-control" required name="photo" type="file" accept="image/*" value="" >
                                </div>
                                <div  class="col-md-6">
